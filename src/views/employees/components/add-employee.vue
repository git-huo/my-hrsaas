  ...
  <el-dialog title="新增员工" :visible="visibleDialog" :before-close="handleClose">
    ...
    <el-form ref="addEmployeeDialog" label-width="120px" :model="formData" :rules="rules">
      ...
      <el-form-item label="部门" prop="departmentName">
        ...
        <el-tree v-if="showTree" v-loading="loading" :data="treeDate" :props="{ label: 'name' }" :default-expand-all="true" @node-click="handleCloseTree" />
      </el-form-item>
    ...
    <template v-slot:footer>
      <el-row type="flex" justify="center">
        <el-col :span="6">
          ...
          <el-button type="primary" size="small" @click="addUserName">确定</el-button>
        </el-col>
      </el-row>
    </template>
  </el-dialog>
