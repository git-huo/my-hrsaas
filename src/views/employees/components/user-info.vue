      ...
      <el-row class="inline-info">
        <el-col :span="12">
          <el-form-item label="员工头像">
            <!-- 放置上传图片 -->
            <ImageUpload ref="employeesHearder" @onSuccess="SuccessHearder" />
          </el-form-item>
        </el-col>
      </el-row>
      <!-- 保存个人信息 -->
    ...
    <el-form label-width="220px">
      <div class="block">
        ...
        <el-form-item label="员工照片">
          <ImageUpload ref="employeesPic" @onSuccess="SuccessPic" />
          <!-- 放置上传图片 -->
        </el-form-item>
